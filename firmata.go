...
func floatBytes(v float32) []byte {
	var (
		...
		signBits     = bits & 0b10000000000000000000000000000000
		exponentBits = bits & 0b01111111100000000000000000000000
		significand  = bits & 0b00000000011111111111111111111111
